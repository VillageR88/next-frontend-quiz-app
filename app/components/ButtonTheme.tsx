...
export default function ButtonTheme() {
  ...
  return (
    ...
    >
      ...
      <div className="flex h-[28px] w-[48px] items-center justify-center rounded-[14.5px] border border-[rgba(0,0,0,0.2)] bg-[#A729F5] transition-colors">
        <div className="size-[20px] -translate-x-2 rounded-full bg-white transition dark:translate-x-2"></div>
      </div>
      <svg
        className="fill-[#626C7F] transition-colors dark:fill-white"
        xmlns="http://www.w3.org/2000/svg"
